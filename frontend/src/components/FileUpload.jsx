        ...
        {file ? (
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              <div>
                <div style={{ fontSize: "13px", fontWeight: 500, color: "var(--text)" }}>{file.name}</div>
                <div style={{ fontSize: "11.5px", color: "var(--text-faint)", fontFamily: "var(--font-mono)" }}>
          ...
          <>
            ...
            <span>
              Drag & drop or <strong style={{ color: "var(--text)", fontWeight: 500 }}>click to upload</strong>
            </span>
