...
function SignInForm() {
  ...
  if (sent) {
    return (
      <div style={{ textAlign: "center", padding: "40px 0" }}>
        ...
        <button onClick={() => { setSent(false); setEmail(""); }} style={{ marginTop: "20px", fontSize: "13px", color: "var(--color-gold)", background: "none", border: "none", cursor: "pointer", fontFamily: "var(--font-sans)" }}>
  ...
  return (
    <div style={{ maxWidth: "400px", margin: "0 auto", padding: "40px 20px" }}>
      ...
      {error && (
        <div style={{ background: "rgba(201,169,98,0.08)", border: "1px solid rgba(201,169,98,0.25)", borderRadius: "var(--radius-md)", padding: "12px 14px", marginBottom: "20px", fontSize: "12.5px", color: "var(--color-gold-light)", lineHeight: 1.6 }}>
      ...
      <form onSubmit={handleMagicLink}>
        <label style={{ display: "block", fontSize: "13px", color: "var(--text-soft)", marginBottom: "6px", fontFamily: "var(--font-sans)" }}>Email address</label>
        <input
          type="email"
          required
          value={email}
      ...
      <p style={{ textAlign: "center", fontSize: "11px", color: "var(--text-faint)", marginTop: "28px", lineHeight: 1.6 }}>
