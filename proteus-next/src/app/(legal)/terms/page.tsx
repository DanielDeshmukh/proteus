      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "48px 24px 80px" }}>
        ...
        <div style={{ fontSize: "14.5px", color: "var(--text-soft)", lineHeight: 1.8, fontFamily: "var(--font-sans)" }}>
          ...
          <section style={{ marginBottom: "36px" }}>
            ...
            <p>
              All AI analysis is performed using third-party language models via Groq and Google Gemini APIs. Results are generated probabilistically and should be reviewed by the user before use.
            </p>
          </section>
